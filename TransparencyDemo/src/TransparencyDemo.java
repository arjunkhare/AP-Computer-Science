 ...
 * has a main() routine as a stand-alone application.  The nested static
 * class TransparencyDemo.Applet runs the program as an applet.
 */
   ...
   private JPanel display = new JPanel() {
      ...
      public void paintComponent(Graphics g) {
         ...
         g.fillPolygon(new int[] { scaleX(0.25), scaleX(0.7), scaleX(0.1) },
               ...
               3);
         g.fillPolygon(new int[] { scaleX(0.1), scaleX(0.2), scaleX(0.1), scaleX(0.6) },
               new int[] { scaleY(0.1), scaleY(0.4), scaleY(0.7), scaleY(0.3) },
               4);
